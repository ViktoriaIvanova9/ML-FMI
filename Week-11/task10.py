...
# Започваме от L назад
# dL/dL = 1 защото x'= 1
# продължаваме към предишния
# dL/dd, L=d*f, => dL/dd=f => grad на d = data на f = -2
# така продължаваме да пресмятаме както на упражнения,
# използвайки свойството че dL/dd = dL/df * df/dd